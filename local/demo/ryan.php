...
if ($kieran_form->is_cancelled()) {
	...
	$check = $data->test1;
	redirect($CFG->wwwroot.'/local/demo/view.php');//'/local/demo/ryan.php?id='.$data->test1);
} else {
	echo $OUTPUT->header();
	$kieran_form->display();
	echo $OUTPUT->footer();
